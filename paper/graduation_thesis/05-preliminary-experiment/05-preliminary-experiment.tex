...
\
\paragraph{収音のためのハードウェア構成について}\label{hardware-for-record}
...
\
\paragraph{収音に使用するソフトウェアについて}\label{software-for-record}
...
\
\paragraph{メモリ使用量について}\label{about-memory}
...
\
\paragraph{演算時間について}\label{about-time}
