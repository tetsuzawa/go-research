...
\item
  ...
  \begin{figure}[H]
  \centering
  \includegraphics[width=11cm]{figures/hquad500_hardware.jpg}
  \caption{ドローンの機体}
  \label{fig:hquad500}
  \end{figure}
  \\
...
\item
  ...
  \begin{figure}[H]
  \centering
  \includegraphics[width=11cm]{figures/esc.jpg}
  \caption{ESC}
  \label{fig:esc}
  \end{figure}
  \\
...
\item
  ...
  \begin{figure}[H]
  \centering
  \includegraphics[width=11cm]{figures/brushless_motor.jpg}
  \caption{ブラシレスモータ}
  \label{fig:motor}
  \end{figure}
  \\
...
\item
  ...
  \begin{figure}[H]
  \centering
  \includegraphics[width=11cm]{figures/quadrino_nano.jpg}
  \caption{フライトコントローラ}
...
\item
  ...
  \begin{figure}[H]
  \centering
  \includegraphics[width=11cm]{figures/lipo_charger.jpg}
  \caption{リポバッテリー充電器}
...
\item
  ...
  \begin{figure}[H]
  \centering
  \includegraphics[width=11cm]{figures/lipo_battery.jpg}
  \caption{リポバッテリー}
...
\item
  ...
  \begin{figure}[H]
  \centering
  \includegraphics[width=11cm]{figures/r9ds.jpg}
  \caption{ラジオレシーバ}
...
\item
  ...
  \begin{figure}[H]
  \centering
  \includegraphics[width=11cm]{figures/at9s.jpg}
  \caption{トランスミッタ}
...
使用した素子は秋月電子のエレクトレットコンデンサマイクロホン（SPL (Hong Kong) Limited, XCM6035）である. 左右用にそれぞれエレクトレットコンデンサマイクはロボットケーブルとはんだ付けし, ケーブルの端をステレオミニプラグと接続して製作した. 
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=13cm]{figures/binaural_mic.png}
    \caption{バイノーラルマイク}
