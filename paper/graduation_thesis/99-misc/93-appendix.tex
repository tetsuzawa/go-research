...
\begin{lstlisting}[caption=calc\_stereo2mono_LR.py,label=calc\_stereo2mono_LR.py]
# coding:utf-8
import sys
...
\begin{lstlisting}[caption=cmd/calc_noise_mix/main.go,label=calc_noise_mix]
package main
...
\begin{lstlisting}[caption=cmd/convolve_wav_fast/main.go,label=convolve_wav_fast]
package main
...
\begin{lstlisting}[caption=cmd/csv_to_wav/main.go,label=csv_to_wav]
    package main
...
\begin{lstlisting}[caption=cmd/drone_json_generator/main.go,label=drone_json_generator]
package main
...
\begin{lstlisting}[caption=cmd/calc_mse_csv/main.go,label=calc_mse_csv]
package main
...
\begin{lstlisting}[caption=cmd/multirecord/wav_to_DSB.go,label=multirecord/wav_to_DSB]
/*
Contents: multi channel record.
	This program works as typical recording app with multi channels.
	Output file format is .wav.
...
\begin{lstlisting}[caption=cmd/wav_to_DSB/main.go,label=wav_to_DSB/main]
/*
...
\begin{lstlisting}[caption=cmd/wav_to_DSB/util.go,label=wav_to_DSB/util]
package main
...
\begin{lstlisting}[caption=cmd/wav_to_DSB/wtod.go,label=wav_to_DSB/wtod]
package main
