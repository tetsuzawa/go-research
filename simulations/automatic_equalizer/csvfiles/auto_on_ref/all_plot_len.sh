...
for algo in NLMS RLS; do
  ...
  python /Users/tetsu/personal_files/Research/research_tools/plot_MSE_iter_from_csv_multi_v2.py ${algo}_${APP_NAME}_L-4_mse.csv ${algo}_${APP_NAME}_L-16_mse.csv ${algo}_${APP_NAME}_L-64_mse.csv ${algo}_${APP_NAME}_L-128_mse.csv ${algo}_${APP_NAME}_L-256_mse.csv --dst_path ../../imgfiles/${APP_NAME}
  echo -e "\n\n\n"
done
...
for algo in AP; do
  ...
  python /Users/tetsu/personal_files/Research/research_tools/plot_MSE_iter_from_csv_multi_v2.py ${algo}_${APP_NAME}_L-4_order-8_mse.csv ${algo}_${APP_NAME}_L-16_order-8_mse.csv ${algo}_${APP_NAME}_L-64_order-8_mse.csv ${algo}_${APP_NAME}_L-128_order-8_mse.csv ${algo}_${APP_NAME}_L-256_order-8_mse.csv --dst_path ../../imgfiles/${APP_NAME}
  echo -e "\n\n\n"
done
